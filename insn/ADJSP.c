...
/* This test case calls a function with five words of arguments.
   ...
   passed on stack, forcing an ADJSP.  */
static void
adjsp1 (Sint AC1, Sint AC2, Sint AC3, Sint AC4)
{
...
/* Calling clobber() clobbers the value in ACs 1 and 2, so they are
   ...
   saved in the stack frame, which is allocated with ADJSP.  */
static Dint
adjsp3 (Dint AC)
{
